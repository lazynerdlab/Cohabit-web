  ...
  return (
    <div className="w-full mx-auto">
      <div className="w-[98%] mx-auto grid grid-cols-1 py-[0.5rem] gap-[0.5rem]">
        ...
        <div className="w[98%] py-[1rem] px[2rem] gap-[0.5rem] grid grid-cols-3 items-center justify-between">
          <div className="bg-[#010886] flex items-center justify-between gap-[0.3rem] text-[48px] font-[700] text-[#FFF] p-[15px]">
            <span>76</span>
            <span className="text-[18px] font-[400]">View your apartment</span>
          ...
          <div className="bg-[#9CA9F9] flex items-center justify-between gap-[0.3rem] text-[48px] font-[700] text-[#000] p-[15px]">
            <span>24</span>
            <span className="text-[18px] font-[400]">Messages received</span>
            <ShortArrow className="stroke-[#000]" />
          </div>
        </div>
        ...
        <div className="w-[98%] mx-auto grid grid-cols-[60%_10%] items-center justify-between">
