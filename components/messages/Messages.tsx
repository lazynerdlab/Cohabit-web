    ...
    <div className="grid grid-cols-1 md:grid-cols-[30%_70%] min-h-[85svh] ">
      ...
      >
        <div className={`sticky md:top-0 top-[10%] z-[9999999999] bg-[#FFF] md:bg-[#32475C]/[4%] flex justify-between items-center w-full p-[2%] border-b border-[#32475C1F] `}>
          ...
          <Input
            className="!rounded-[66px] max-w-[200px] absolute right-10"
        ...
        <div className="flex flex-col gap-[0.5rem] max-h[78vh] justify-between overflow-hidden md:overflow-y-scroll mb-[3%] relative noscroll-bar bg-[#32475C]/[4%]">
          {messagesLoading || searchedLoading ? (
