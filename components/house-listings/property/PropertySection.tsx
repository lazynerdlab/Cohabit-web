  ...
  return (
    <div className="w-full mt-[6rem]">
      <div className="p-[0.5rem] border border-[#D6DDEB] px-[20px] py-[13px] flex flex-col gap-[0.3rem]">
        <h4 className="text-[#25324B] text-[24px] font-[700]">Description</h4>
      ...
      <div className="p-[0.5rem] border border-[#D6DDEB] px-[20px] py-[13px] flex flex-col gap-[0.3rem]">
        <h4 className="text-[#25324B] text-[24px] font-[700]">Key Features</h4>
        <p className="text-[16px] font-[400] text-[#515B6F]">
          1. Spacious Living Areas: The interior boasts a generous open-concept
        ...
        <p className="text-[16px] font-[400] text-[#515B6F]">
          2. Modern Kitchen: The well-appointed kitchen is equipped with modern
          ...
          the occasional culinary adventure, this kitchen has everything you
          need.
        </p>
        <p className="text-[16px] font-[400] text-[#515B6F]">
        ...
        <p className="text-[16px] font-[400] text-[#515B6F]">
          5. Pet-Friendly: Your four-legged friends are welcome here! The
          property's pet-friendly policy allows for furry companions to share in
      ...
      <div className="p-[0.5rem] border border-[#D6DDEB] px-[20px] py-[13px] flex flex-col gap-[0.3rem]">
        <h4 className="text-[#25324B] text-[24px] font-[700]">Location</h4>
        <Image alt="map" src={map} />
      </div>
      <div className="p-[0.5rem] border border-[#D6DDEB] px-[20px] py-[13px] flex flex-col gap-[0.3rem]">
        <h4 className="text-[#25324B] text-[24px] font-[700]">Rating</h4>
      ...
      <div className="p-[0.5rem] border border-[#D6DDEB] px-[20px] py-[13px] flex flex-col gap-[0.3rem]">
        <h4 className="text-[#25324B] text-[24px] font-[700]">Review</h4>
        <p className="text-[16px] font-[400] text-[#515B6F]">
