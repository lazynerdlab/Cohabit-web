...
const PropertySection = () => {
  return (
    <div className="grid grid-cols-[75%_25%] w-full mt-[6rem]">
      <div>
        ...
        <div className="p-[0.5rem] border border-[#D6DDEB] px-[20px] py-[13px] flex flex-col gap-[0.3rem]">
          ...
          <p className="text-[16px] font-[400] text-[#515B6F]">
            ...
            open-concept layout, creating an inviting and airy atmosphere. The
            living room is bathed in natural light, creating a perfect space for
