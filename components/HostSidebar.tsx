    ...
    const items: MenuProps["items"] = useMemo(
        () => [
            getItem(
                ...
                "/host",
                <HomeIconsm
                    className={`${path === "/host" ? "stroke-colorPrimary" : "stroke-[#7C8493]"
                        } h-[18px]`}
                />
            ),
            ...
            getItem(
                ...
                "/host/house-listing",
                <MessageIcon
                    className={`${path.includes("house-listing")
                        ? "stroke-colorPrimary"
                        : "stroke-[#7C8493]"
                        } h-[18px]`}
                />
            ...
            getItem(
                ...
                "/host/pricing",
                <SearchIcon
                    className={`${path.includes("pricing")
                        ? "stroke-colorPrimary"
                        : "stroke-[#7C8493]"
                        } h-[18px]`}
                />
            ...
            getItem(
                ...
                <UserIcon
                    className={`${path.includes("profile/host")
                        ? "stroke-colorPrimary"
                        : "stroke-[#7C8493]"
                        } h-[18px]`}
                />
